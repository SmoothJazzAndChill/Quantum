...
const std::string ModelPath = "src/Assets/Models/chalet.obj";
const std::string TexturePath = "src/Assets/Textures/chalet.jpg";
...
namespace std
{
	template<> struct hash<Vertex>
	{
		...
		{
			return ((hash<glm::vec3>()(_Vertex.Pos) ^ (hash<glm::vec3>()(_Vertex.Color) << 1)) >> 1) ^ (hash<glm::vec2>()(_Vertex.TexCoord) << 1);
		}
	};
}
...
#pragma region Callback
	...
	{
		auto App = reinterpret_cast<QuantumGraphics*>(glfwGetWindowUserPointer(Window));
...
#pragma region Drawing
	...
	void UpdateUniformBuffer(uint32_t CurrentImage)
	{
		...
		UBO.View = glm::lookAt(glm::vec3(3.0f, 0.0f, 0.5f), glm::vec3(0.0f, 0.0f, 0.5f), glm::vec3(0.0f, 0.0f, 1.0f));
...
#pragma region Texturing
	void CreateTextureImage()
	{
		...
		VkDeviceSize ImageSize = (uint64_t)TextureWidth * (uint64_t)TextureHeight * (uint64_t)4;
